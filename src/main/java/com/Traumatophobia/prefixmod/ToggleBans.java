...
public class ToggleBans implements IClientCommand {
	...
	public void execute(MinecraftServer arg0, ICommandSender arg1, String[] arg2) throws CommandException {
		...
		if (Toggled == true) {
			Toggled = false;
			telluser.appendText("[SkyblockBans] notifications enabled");
		}
		else if (Toggled == false) {
			Toggled = true;
			telluser.appendText("[SkyblockBans] notifications disabled");
