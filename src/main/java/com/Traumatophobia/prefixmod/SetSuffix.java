...
public class SetSuffix implements IClientCommand {
	...
	public void execute(MinecraftServer arg0, ICommandSender arg1, String[] arg2) throws CommandException {
		...
		if (arg2.length == 0) {
			Minecraft.getMinecraft().player.sendMessage(new TextComponentString("Suffix Reset"));
			ChatPrefix = "";
		}
	    	...
	    	Minecraft.getMinecraft().player.sendMessage(new TextComponentString("Your Suffix: [Chat] "+newstring));
