...
public class AutoFix implements IClientCommand {
	...
	public void execute(MinecraftServer arg0, ICommandSender arg1, String[] arg2) throws CommandException {
		...
		if (PrefixMod.autofix == true) {
			PrefixMod.autofix = false;
			telluser.appendText("Auto Fix Disabled");
		}
		else if (PrefixMod.autofix == false) {
			PrefixMod.autofix = true;
			telluser.appendText("Auto Fix Enabled");
