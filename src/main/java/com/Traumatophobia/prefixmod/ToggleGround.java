...
public class ToggleGround implements IClientCommand {
	...
	public void execute(MinecraftServer arg0, ICommandSender arg1, String[] arg2) throws CommandException {
		...
		if (Toggled == true) {
			Toggled = false;
			telluser.appendText("Enabled 'Ground items' displayed in chat");
		}
		else if (Toggled == false) {
			Toggled = true;
			telluser.appendText("Disabled 'Ground items' displayed in chat");
